...
// },
    ...
    },
    {
        ...
        "correctOption": 2,
        "points": 30,
        "explanation":"• pass کردن function به‌عنوان prop از Server به Client Component مجاز نیست\n" +
            "• functions قابل serialize نیستند و نمی‌توانند از server به client منتقل شوند\n" +
            "• فقط serializable data types مثل strings و numbers و plain objects مجاز هستند\n" +
            "• event handlers باید در Client Component تعریف شوند\n" +
            "• این محدودیت به دلیل ماهیت distributed system است\n" +
            "• نکته: برای logic که نیاز به function دارد از Server Actions استفاده کنید"
    },
    {
        "id": 612,
        ...
        "correctOption": 3,
        "points": 30,
        "explanation":"• fetch کردن data با async و await داخل Server Component انجام می‌شود نه Client\n" +
            "• Server Components برای data fetching مناسب‌تر هستند\n" +
            "• Client Components برای interactivity مثل button clicks و form inputs هستند\n" +
            "• data fetching در Server باعث کاهش client bundle و بهبود performance می‌شود\n" +
            "• Client Components معمولاً data را از props دریافت می‌کنند\n" +
            "• نکته: fetch کردن در Server Component سپس pass کردن data به Client Component بهترین pattern است"
    },
    {
        "id": 613,
        ...
        "correctOption": 3,
        "points": 30,
        "explanation": "• Server Components خودکار با هر local state change دوباره render نمی‌شوند\n" +
            "• Server Components state ندارند و فقط با navigation یا revalidation دوباره render می‌شوند\n" +
            "• local state فقط در Client Components وجود دارد\n" +
            "• Server Components static هستند تا زمانی که صفحه دوباره fetch شود\n" +
            "• برای reactive behavior نیاز به Client Component است\n" +
            "• نکته: Server Components برای محتوای ثابت و Client Components برای interactive UI استفاده کنید"
    },
    {
        "id": 614,
        ...
        "correctOption": 1,
        "points": 30,
        "explanation":"• Client Components نمی‌توانند Server Components را import کنند و به client-side logic برگردند\n" +
            "• import کردن Server Component در Client باعث تبدیل آن به Client می‌شود\n" +
            "• این رفتار نادرست است و باید از composition استفاده کرد\n" +
            "• Server Components باید به‌عنوان children یا props پاس شوند\n" +
            "• circular imports بین server و client boundaries مجاز نیست\n" +
            "• نکته: همیشه از composition pattern برای ترکیب Server و Client Components استفاده کنید"
    },
    {
        "id": 615,
        ...
        "correctOption": 2,
        "points": 30,
        "explanation":"• اگر state فقط در یک Client Component استفاده می‌شود و sibling ندارد نیازی به lifting up نیست\n" +
            "• state می‌تواند local و isolated بماند\n" +
            "• lifting state up فقط برای sharing بین multiple components است\n" +
            "• اگر هیچ کامپوننت دیگری نیاز به این state ندارد آن را local نگه دارید\n" +
            "• این باعث simplicity و بهتر performance می‌شود\n" +
            "• نکته: state را تا جایی که ممکن است local نگه دارید و فقط در صورت نیاز lift up کنید"
    },
    {
        "id": 616,
        ...
        "correctOption": 0,
        "points": 30,
        "explanation": "• Server Components خودکار با local state changes در child Client Components دوباره render نمی‌شوند\n" +
            "• Server Components state ندارند و reactive نیستند\n" +
            "• فقط با navigation یا explicit revalidation دوباره render می‌شوند\n" +
            "• Client Component state changes فقط آن Client Component را re-render می‌کند\n" +
            "• Server Components independent از Client Component state هستند\n" +
            "• نکته: این جداسازی یکی از مزایای RSC architecture است"
    },
    {
        "id": 617,
        ...
        "correctOption": 0,
        "points": 20,
        "explanation":"• Page Component به‌طور پیش‌فرض در server اجرا می‌شود مگر با use client مشخص شود\n" +
            "• در Next.js App Router تمام کامپوننت‌ها Server Component هستند\n" +
            "• برای تبدیل به Client Component باید use client اضافه کنید\n" +
            "• این default behavior باعث بهتر performance می‌شود\n" +
            "• فقط کامپوننت‌هایی که نیاز به interactivity دارند Client می‌شوند\n" +
            "• نکته: این رویکرد opt-in برای client-side code باعث کاهش bundle size می‌شود"
    },
    {
        "id": 618,
        ...
        "correctOption": 0,
        "points": 20,
        "explanation": "• loading.js برای نمایش temporary loading state یا skeleton UI در زمان fetch شدن data استفاده می‌شود\n" +
            "• این فایل خودکار توسط Next.js به Suspense boundary تبدیل می‌شود\n" +
            "• وقتی Server Component در حال fetch کردن data است loading UI نمایش داده می‌شود\n" +
            "• بهبود تجربه کاربری با نمایش feedback بصری\n" +
            "• جایگزین نوشتن manual Suspense boundaries است\n" +
            "• نکته: loading.js در هر سطح از route hierarchy قابل تعریف است برای granular loading states"
    },
    {
        "id": 619,
        ...
        "correctOption": 3,
        "points": 30,
        "explanation": "• اگر JavaScript غیرفعال باشد فقط server-rendered content بدون interactive loading نمایش داده می‌شود\n" +
            "• loading.js به JavaScript برای نمایش loading state نیاز دارد\n" +
            "• بدون JavaScript هیچ Suspense boundary یا loading indicator کار نمی‌کند\n" +
            "• Server Component همچنان render می‌شود اما بدون loading feedback\n" +
            "• کاربر فقط HTML نهایی را می‌بیند بعد از complete شدن fetch\n" +
            "• نکته: Progressive Enhancement را در نظر بگیرید که اپلیکیشن بدون JavaScript هم کار کند"
    },
    {
        "id": 620,
        ...
        "correctOption": 1,
        "points": 20,
        "explanation": "• اگر child component نیاز به client-side state یا hooks ندارد Server Component می‌تواند آن را render کند\n" +
            "• فقط کامپوننت‌هایی که interactivity دارند نیاز به use client دارند\n" +
            "• Server Components می‌توانند children را بدون use client به‌عنوان Server Component render کنند\n" +
            "• این باعث کاهش client bundle می‌شود\n" +
    ...
    },
    {
        ...
        "correctOption": 0,
        "points": 20,
        "explanation": "• بله اما SVG files توسط Image component optimize نمی‌شوند\n" +
            "• SVG ها vector هستند و نیازی به optimization ندارند\n" +
            "• می‌توانید SVG را با Image component استفاده کنید\n" +
            "• اما lazy loading و دیگر features اعمال می‌شوند\n" +
            "• format conversion برای SVG اتفاق نمی‌افتد\n" +
            "• نکته: برای SVG های ساده می‌توانید inline استفاده کنید"
    },
    {
        "id": 712,
        ...
        "correctOption": 1,
        "points": 20,
        "explanation": "• با unoptimized تصویر اصلی بدون هیچ processing سرو می‌شود\n" +
            "• هیچ optimization یا format conversion انجام نمی‌شود\n" +
            "• تصویر دقیقاً همانطور که هست ارسال می‌شود\n" +
            "• برای مواردی که نمی‌خواهید Next.js دخالت کند\n" +
            "• مثلاً برای GIF های animated که نباید تبدیل شوند\n" +
            "• نکته: معمولاً نیازی به این property نیست مگر دلیل خاص"
    },
    {
        "id": 713,
        ...
        "correctOption": 0,
        "points": 30,
        "explanation": "• با بهینه‌سازی LCP از طریق priority loading و optimization\n" +
            "• کاهش CLS با reserve کردن space با dimensions\n" +
            "• بهبود loading performance با lazy loading و format optimization\n" +
            "• تمام این metrics در Core Web Vitals مهم هستند\n" +
            "• تأثیر مستقیم روی SEO ranking\n" +
            "• نکته: استفاده صحیح از Image component می‌تواند scores را به‌طور قابل توجهی بهبود دهد"
    },
    {
        "id": 714,
        ...
        "correctOption": 2,
        "points": 30,
        "explanation": "• سرو کردن appropriately sized images برای هر device\n" +
            "• mobile کوچک‌تر و desktop بزرگ‌تر\n" +
            "• browser خودکار مناسب‌ترین size را انتخاب می‌کند\n" +
            "• srcset و sizes attributes خودکار تولید می‌شوند\n" +
            "• صرفه‌جویی bandwidth و faster loading\n" +
            "• نکته: این رفتار پیش‌فرض Image component است"
    },
    {
        "id": 715,
        ...
        "correctOption": 0,
        "points": 20,
        "explanation":"• fill باعث می‌شود image تمام parent container را پر کند\n" +
            "• دیگر نیازی به تعیین width و height نیست\n" +
            "• image به اندازه parent stretch یا fit می‌شود\n" +
            "• مفید برای background images و hero sections\n" +
            "• parent باید position: relative داشته باشد\n" +
            "• نکته: با objectFit می‌توانید رفتار fill را کنترل کنید"
    },
    {
        "id": 716,
        ...
        "correctOption": 1,
        "points": 20,
        "explanation": "• parent container باید position: relative یا absolute styling داشته باشد\n" +
            "• بدون این image نمی‌داند نسبت به چه position بگیرد\n" +
            "• image به‌صورت absolute position می‌شود\n" +
            "• این برای proper containment ضروری است\n" +
            "• معمولاً relative راحت‌تر و common تر است\n" +
            "• نکته: فراموش کردن این styling یکی از شایع‌ترین اشتباهات است"
    },
    {
        "id": 717,
        ...
        "correctOption": 0,
        "points": 20,
        "explanation":"• object-cover باعث می‌شود image با حفظ aspect ratio container را بپوشاند\n" +
            "• تصویر ممکن است crop شود تا container را پر کند\n" +
            "• aspect ratio اصلی حفظ می‌شود بدون distortion\n" +
            "• مشابه background-size: cover در CSS\n" +
            "• برای hero images و backgrounds مناسب است\n" +
            "• نکته: این یک Tailwind class است که objectFit: 'cover' را اعمال می‌کند"
    },
    {
        "id": 718,
        ...
        "correctOption": 2,
        "points": 30,
        "explanation":"• object-cover تصویر را crop می‌کند تا container را پر کند\n" +
            "• object-contain تمام تصویر را نمایش می‌دهد با حفظ aspect ratio\n" +
            "• cover ممکن است بخشی از تصویر را قطع کند\n" +
            "• contain ممکن است empty space در container داشته باشد\n" +
            "• cover برای backgrounds و contain برای product images\n" +
            "• نکته: انتخاب بستگی به اینکه می‌خواهید کل تصویر یا کل container پر شود دارد"
    },
    {
        "id": 719,
        ...
        "correctOption": 2,
        "points": 20,
        "explanation": "• object-top موقعیت تصویر را داخل container کنترل می‌کند\n" +
            "• تصویر را به top container align می‌کند\n" +
            "• وقتی crop می‌شود از bottom crop می‌شود نه top\n" +
            "• مفید برای portraits که صورت در بالا است\n" +
            "• گزینه‌های دیگر: object-center و object-bottom و object-left\n" +
            "• نکته: این objectPosition در CSS را کنترل می‌کند"
    },
    {
        "id": 720,
        ...
        "correctOption": 1,
        "points": 30,
        "explanation": "• نه fill و dimensions یعنی width/height با هم mutually exclusive هستند\n" +
            "• یا از fill استفاده می‌کنید یا از width/height\n" +
            "• fill یعنی image به اندازه parent می‌شود\n" +
            "• width/height یعنی image اندازه مشخصی دارد\n" +
            "• استفاده همزمان منطقی نیست و error می‌دهد\n" +
            "• نکته: بر اساس layout نیازتان یکی را انتخاب کنید"
    },
    {
        "id": 721,
    ...
    },
 {
    ...
    },
    {
        ...
        "correctOption": 3,
        "points": 10,
        "explanation": "• ساختار app/posts/[id]/page.js برای single parameter route\n" +
            "• square brackets مشخص می‌کنند که این بخش dynamic است\n" +
            "• [id] یک route parameter است\n" +
            "• می‌تواند هر value داشته باشد\n" +
            "• Next.js این را به dynamic route تبدیل می‌کند\n" +
            "• نکته: نام داخل brackets به‌عنوان parameter name استفاده می‌شود"
    },
    {
        "id": 792,
        ...
        "correctOption": 0,
        "points": 20,
        "explanation":"• با استفاده از [...slug] bracket folder naming\n" +
            "• three dots قبل از نام یعنی catch-all\n" +
            "• تمام segments بعد از این path را match می‌کند\n" +
            "• مثلاً /shop/a و /shop/a/b و /shop/a/b/c\n" +
            "• params.slug یک آرایه از segments است\n" +
            "• نکته: مفید برای nested categories یا file paths"
    },
    {
        "id": 793,
        ...
        "correctOption": 1,
        "points": 20,
        "explanation":"• تمام segments بعد از base path را match می‌کند\n" +
            "• می‌تواند یک یا چند segment باشد\n" +
            "• مثلاً /docs/a یا /docs/a/b/c\n" +
            "• هیچ محدودیت depth ندارد\n" +
            "• params.slug آرایه‌ای از همه segments است\n" +
            "• نکته: این برای deeply nested paths مفید است"
    },
    {
        "id": 794,
        ...
        "correctOption": 2,
        "points": 30,
        "explanation":"• با استفاده از [[...slug]] یعنی double bracket notation\n" +
            "• این route را optional می‌کند\n" +
            "• هم base path و هم nested paths را match می‌کند\n" +
            "• مثلاً /shop و /shop/a و /shop/a/b\n" +
            "• [...slug] base path را match نمی‌کند اما [[...slug]] می‌کند\n" +
            "• نکته: double brackets برای flexibility بیشتر"
    },
    {
        "id": 795,
        ...
        "correctOption": 1,
        "points": 30,
        "explanation":"• [[...slug]] base route را هم match می‌کند در حالی که [...slug] نمی‌کند\n" +
            "• [[...slug]] optional است\n" +
            "• [...slug] حداقل یک segment نیاز دارد\n" +
            "• [[...slug]] می‌تواند zero segments داشته باشد\n" +
            "• این تفاوت در matching base path است\n" +
            "• نکته: optional catch-all برای root و nested routes مفید است"
    },
    {
        "id": 796,
        ...
        "correctOption": 0,
        "points": 20,
        "explanation":"• params.slug یک آرایه از segments برمی‌گرداند\n" +
            "• نه یک string واحد\n" +
            "• هر element یک path segment است\n" +
            "• مثلاً /shop/a/b → params.slug = ['a', 'b']\n" +
            "• می‌توانید array methods استفاده کنید\n" +
            "• نکته: همیشه بررسی کنید که slug آرایه است"
    },
    {
        "id": 797,
        ...
        "correctOption": 3,
        "points": 20,
        "explanation":"• بله مثل [category]/[id]/page.js structure\n" +
            "• هر segment می‌تواند dynamic باشد\n" +
            "• params هر دو را شامل می‌شود\n" +
            "• مثلاً params.category و params.id\n" +
            "• ترتیب مهم است\n" +
            "• نکته: این برای nested dynamic routing مفید است"
    },
    {
        "id": 798,
        ...
        "correctOption": 2,
        "points": 30,
        "explanation": "• با export کردن generateStaticParams function از page component\n" +
            "• این function آرایه‌ای از parameter objects برمی‌گرداند\n" +
            "• Next.js هر کدام را pre-render می‌کند\n" +
            "• برای Static Site Generation با dynamic routes\n" +
            "• در build time اجرا می‌شود\n" +
            "• نکته: این جایگزین getStaticPaths در App Router است"
    },
    {
        "id": 799,
        ...
        "correctOption": 0,
        "points": 20,
        "explanation":"• آرایه‌ای از parameter objects برای routes برمی‌گرداند\n" +
            "• هر object کلیدهای مطابق با dynamic segments دارد\n" +
            "• مثلاً [{id: '1'}, {id: '2'}]\n" +
            "• Next.js برای هر object یک static page می‌سازد\n" +
            "• این در build time اجرا می‌شود\n" +
            "• نکته: می‌توانید از database یا API برای generate کردن لیست استفاده کنید"
    },
    {
        "id": 800,
        ...
        "correctOption": 1,
        "points": 20,
        "explanation": "• در build time برای static generation اجرا می‌شود\n" +
            "• قبل از rendering pages\n" +
            "• فقط یک‌بار در زمان build\n" +
            "• نه در runtime یا development\n" +
            "• output برای pre-rendering استفاده می‌شود\n" +
