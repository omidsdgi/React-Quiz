...
export const mockQuestions: Question[] = [
  {
    id: 1,
    question:
      "Which JavaScript framework has the largest developer community as of 2024?",
  ...
  },
  {
    id: 5,
    question:
      "In React’s data flow model, how does data typically move between components?",
    options: [
  ...
  },
  {
    id: 6,
    question:
      "What mechanism is used to pass data from parent to child components?",
  ...
  },
  {
    id: 9,
    question:
      "In React applications, when should you directly manipulate the DOM?",
    options: [
  ...
  },
  {
    id: 10,
    question:
      "When should you use a callback function to update state in React?",
    options: [
  ...
  },
  {
    id: 14,
    question:
      "Does a useEffect hook always run on the component's initial render?",
    options: [
  ...
  },
  {
    id: 15,
    question:
      "How often will a useEffect run if no dependency array is provided?",
    options: [
  ...
  },
  {
    id: 18,
    question:
      "What capability does routing provide to users in React applications?",
    options: [
  ...
  },
  {
    id: 23,
    question:
      "Where does rendering primarily occur in Single Page Applications?",
    options: [
  ...
  },
  {
    id: 25,
    question:
      "What primarily drives content updates in Single Page Applications?",
    options: [
  ...
  },
  {
    id: 26,
    question:
      "What is a significant SEO challenge for Single Page Applications?",
    options: [
  ...
  },
  {
    ...
    options: [".eslint.config.js", ".eslint", ".eslintrc.json", ".linterrc.js"],
    correctOption: 2,
    points: 20,
  },
  {
  ...
  },
  {
    ...
    options: ["eslint-check", "lint-start", "eslint .", "node run eslint"],
    correctOption: 2,
    points: 20,
  },
  {
  ...
  },
  {
    id: 38,
    question:
      "How do 'rules', 'extends', and 'plugins' differ in ESLint configuration?",
    options: [
  ...
  },
  {
    ...
    options: ["useState", "useEffect", "useSearchParams", "useMemo"],
    correctOption: 2,
    points: 10,
  },
  {
  ...
  },
  {
    id: 47,
    question:
      "Which hook prevents unnecessary function recreation on re-renders?",
  ...
  },
  {
    id: 54,
    question:
      "Which hook is most appropriate for optimizing expensive calculations?",
  ...
  },
  {
    id: 55,
    question:
      "How can you prevent a component from re-rendering when its parent re-renders?",
    options: [
  ...
  },
  {
    id: 59,
    question:
      "What happens when useMemo depends on a value that changes every render?",
    options: [
  ...
  },
  {
    id: 63,
    question:
      "What is the recommended approach for handling very large lists in React?",
    options: [
  ...
  },
  {
    id: 72,
    question:
      "What is the recommended technique for rendering thousands of list items?",
    options: [
  ...
  },
  {
    id: 75,
    question:
      "Which hook maintains a mutable value without triggering re-renders?",
  ...
  },
  {
    id: 76,
    question:
      "Why can't you directly use fetch API calls inside Redux reducers?",
    options: [
  ...
  },
  {
    id: 77,
    question:
      "Why do some effects execute twice in React.StrictMode during development?",
    options: [
  ...
  },
  {
    id: 78,
    question:
      "What are the primary areas of focus for React performance optimization?",
    options: [
  ...
  },
  {
    id: 81,
    question:
      "What technique improves performance when rendering large lists in React?",
    options: [
...

  {
    id: 83,
    question:
      "Which combination addresses the three main React optimization areas?",
    options: [
...

  {
    id: 88,
    question:
      "How can you prevent Context consumers from re-rendering when unrelated data changes?",
    options: [
  ...
  },
  {
    id: 89,
    question:
      "What is the performance impact when a component uses Context?\n\nconst Component = () => {\n  const { theme } = useContext(AppContext);\n  return <div className={theme}>Content</div>;\n}",
    options: [
  ...
  },
  {
    id: 90,
    question:
      "Which approach prevents creating new context value objects on every render?",
    options: [
  ...
  },
  {
    id: 95,
    question:
      "When do wasted renders become a significant performance problem?",
    options: [
  ...
  },
  {
    id: 96,
    question:
      "Why is passing heavy components as children often more efficient than rendering them directly in a stateful parent?",
    options: [
  ...
  },
  {
    id: 97,
    question:
      "What happens when an expensive component is rendered directly inside a parent with frequent state updates?",
    options: [
  ...
  },
  {
    id: 98,
    question:
      "How does React decide whether to re-render child components passed as props?",
    options: [
  ...
  },
  {
    id: 99,
    question:
      "What is the best practice for expensive child components in frequently updating parents?",
    options: [
  ...
  },
  {
    id: 100,
    question:
      "Why doesn't passing children always guarantee better performance?",
    options: [
  ...
  },
  {
    id: 110,
    question:
      "Why doesn't React.memo improve performance when objects are passed as props?",
    options: [
  ...
  },
  {
    id: 111,
    question:
      "Why is React.memo ineffective when functions are passed as props?",
    options: [
  ...
  },
  {
    id: 115,
    question:
      "What similarity exists between useMemo dependency arrays and React.memo?",
    options: [
  ...
  },
  {
    id: 116,
    question:
      "What happens when useMemo's dependency array doesn't change between renders?",
    options: [
  ...
  },
  {
    id: 117,
    question:
      "Which tool is primarily used for preventing unnecessary component re-renders?",
    options: [
  ...
  },
  {
    id: 119,
    question:
      "Which hook is useful for memoizing values used in dependency arrays of other hooks?",
    options: [
      "useMemo hook for memoizing computed values",
      "useState hook for managing component state",
  ...
  },
  {
    id: 120,
    question:
      "What's the best approach to prevent child component re-renders when props haven't changed?",
    options: [
  ...
  },
  {
    id: 121,
    question:
      "What's the best approach for avoiding expensive recalculations that depend on multiple variables?",
    options: [
  ...
  },
  {
    id: 122,
    question:
      "How should you stabilize expensive values used in other hook dependency arrays?",
    options: [
  ...
  },
  {
    id: 123,
    question:
      "Why does passing arrow functions as props prevent React.memo from working effectively?",
    options: [
  ...
  },
  {
    id: 124,
    question:
      "When do useMemo and useEffect callbacks execute in the component lifecycle?",
    options: [
  ...
  },
  {
    id: 125,
    question:
      "What is the primary difference in purpose between useMemo and useEffect?",
    options: [
  ...
  },
  {
    id: 130,
    question:
      "What happens when a dependency used in useEffect is missing from the dependency array?",
    options: [
  ...
  },
  {
    id: 137,
    question:
      "What happens when state variables are missing from useEffect dependencies?",
    options: [
  ...
  },
  {
    id: 140,
    question:
      "Why can frequently changing Context values cause performance issues?",
    options: [
  ...
  },
  {
    id: 142,
    question:
      "What strategy helps avoid wasted renders in Context with many consumers?",
    options: [
  ...
  },
  {
    id: 147,
    question:
      "Why do inline objects as Context values trigger unnecessary re-renders?",
    options: [
  ...
  },
  {
    id: 148,
    question:
      "What's the recommended way to avoid re-renders with Context objects?",
    options: [
  ...
  },
  {
    id: 165,
    question:
      "What happens to imported but unused libraries with tree-shaking?",
    options: [
  ...
  },
  {
    id: 171,
    question:
      "Why does Link with prefetch=true improve navigation performance?",
    options: [
  ...
  },
  {
    id: 172,
    question:
      "Which strategy is most effective for optimizing initial page load time?",
    options: [
  ...
  },
  {
    id: 174,
    question:
      "Which hook is designed to create reactive computed values in React?",
  ...
  },
  {
    id: 177,
    question:
      "Why must reactive values be included in useEffect dependency arrays?",
    options: [
  ...
  },
  {
    id: 180,
    question:
      "What happens when a reactive value is missing from a dependency array?",
    options: [
  ...
  },
  {
    id: 181,
    question:
      "Which tool automatically detects missing dependencies in useEffect?",
    options: [
  ...
  },
  {
    id: 182,
    question:
      "Why must context values used in useEffect be included in dependency arrays?",
    options: [
  ...
  },
  {
    id: 184,
    question:
      "Why should objects not be used directly as dependencies in hooks?",
    options: [
  ...
  },
  {
    id: 185,
    question:
      "How can you prevent unnecessary re-runs when a function causes dependency issues?",
    options: [
  ...
  },
  {
    id: 186,
    question:
      "What is the best practice for functions that don't reference reactive values?",
    options: [
  ...
  },
  {
    id: 187,
    question:
      "What is a better approach than including entire objects as dependencies?",
    options: [
  ...
  },
  {
    id: 188,
    question:
      "How can you fix objects that don't work correctly as dependencies?",
    options: [
  ...
  },
  {
    id: 189,
    question:
      "What pattern works better when you have multiple related reactive values?",
    options: [
  ...
  },
  {
    id: 193,
    question:
      "What is the recommended way to synchronize multiple state variables?",
    options: [
  ...
  },
  {
    id: 201,
    question:
      "What should a Redux reducer return when it receives an unknown action type?",
    options: [
  ...
  },
  {
    id: 228,
    question:
      "Which solution is best suited for handling server state in modern React apps?",
    options: [
  ...
  },
  {
    id: 229,
    question:
      "What performance issue can arise when using Context API for frequently changing state?",
    options: [
  ...
  },
  {
    id: 230,
    question:
      "Why do many modern React apps no longer need Redux for remote state?",
    options: [
  ...
  },
  {
    id: 231,
    question:
      "Which type of state is best managed locally within a React component?",
    options: [
  ...
  },
  {
    id: 233,
    question:
      "What is the main reason Redux adoption has decreased in recent years?",
    options: [
  ...
  },
  {
    id: 237,
    question:
      "What enables Redux to handle asynchronous operations before updating state?",
    options: [
      "Reducer functions",
      "Store configuration",
      "Thunk middleware",
  ...
  },
  {
    id: 239,
    question:
      "Which capability is NOT provided by Redux Toolkit's createSlice?",
    options: [
  ...
  },
  {
    id: 240,
    question:
      "Which library in Redux Toolkit allows writing code that appears to mutate state while maintaining immutability?",
    options: ["Thunk", "Saga", "Selector", "Immer"],
    correctOption: 3,
    points: 10,
  },
  {
    id: 241,
    question:
      "Which Redux Toolkit API combines reducers and action creators into a single structure?",
    options: [
      "createSlice",
      "configureStore",
      "combineReducers",
  ...
  },
  {
    id: 242,
    question:
      "Which Redux Toolkit function sets up the store with built-in middleware and DevTools?",
    options: ["createReducer", "createStore", "configureStore", "setupStore"],
    correctOption: 2,
    points: 10,
  },
  {
    id: 243,
    question:
      "What is the recommended naming convention for Redux action types?",
    options: [
  ...
  },
  {
    id: 251,
    question:
      "What does createSlice automatically generate based on the reducer functions you define?",
    options: [
  ...
  },
  {
    id: 252,
    question:
      "How many parameters do action creators generated by createSlice typically accept?",
    options: [
  ...
  },
  {
    id: 254,
    question:
      "In createSlice configuration, which property contains the functions that define state updates?",
    options: [
  ...
  },
  {
    id: 255,
    question:
      "What naming pattern do action types follow when generated by createSlice?",
    options: [
  ...
  },
  {
    id: 256,
    question:
      "How do you export the main reducer function from a createSlice result?",
    options: [
  ...
  },
  {
    id: 259,
    question:
      "When would you use the 'prepare' callback in a createSlice reducer?",
    options: [
  ...
  },
  {
    id: 261,
    question:
      "What architectural problem can occur when using multiple Context providers?",
    options: [
  ...
  },
  {
    id: 263,
    question:
      "What advantage does Redux provide over Context API for debugging?",
    options: [
  ...
  },
  {
    id: 265,
    question:
      "Why can Context API cause performance issues with frequent updates?",
    options: [
  ...
  },
  {
    id: 266,
    question:
      "Which tool provides the better debugging experience for state management?",
    options: [
  ...
  },
  {
    id: 271,
    question:
      "Which approach is more efficient for local component subtree state?",
    options: [
      "Redux Toolkit",
  ...
  },
  {
    id: 272,
    question:
      "Which tool is most appropriate for rarely changing global values like theme?",
    options: [
      "React Context",
      "Redux Toolkit",
      "Redux with middleware",
  ...
  },
  {
    id: 276,
    question:
      "What is the primary benefit of declarative programming in React?",
    options: [
  ...
  },
  {
    id: 278,
    question:
      "How does feature-based folder structure improve maintainability?",
    options: [
  ...
  },
  {
    id: 280,
    question:
      "Where should components be placed in feature-based architecture?",
    options: [
  ...
  },
  {
    id: 286,
    question:
      "If a user updates only delivery address of existing order, which HTTP method should be used?",
  ...
  },
  {
    id: 287,
    question:
      "if system needs to create brand new pizza order, which HTTP method should be used?",
    options: ["GET", "POST", "PUT", "PATCH"],
    correctOption: 1,
    points: 20,
  },
  {
    id: 288,
    question:
      "if a admin replaces entire pizza menu with new list, which HTTP method should be used?",
    options: ["GET", "POST", "PUT", "PATCH"],
    correctOption: 2,
    points: 20,
  },
  {
    id: 289,
    question:
      "If a customer views specific order details by ID, which HTTP method should be used?",
    options: ["GET", "POST", "PUT", "PATCH"],
    correctOption: 0,
    points: 10,
  },
  {
    id: 290,
    question:
      "If a customer cancels and removes order completely, which HTTP method should be used?",
  ...
  },
  {
    id: 300,
    question:
      "Why prefer component-based architecture over vanilla JavaScript?",
    options: [
  ...
  },
  {
    id: 340,
    question:
      "Which statement correctly describes how prefetching works in React Query?",
    options: [
  ...
  },
  {
    ...
    options: ["useMutation", "useQuery", "useEffect", "useState"],
    correctOption: 0,
    points: 20,
  },
  {
    id: 373,
    question:
      "Why is it recommended to use mutation callbacks like onSuccess or onError in React Query?",
    options: [
  ...
  },
  {
    id: 375,
    question:
      "How can React Query ensure a smooth user experience when the app is offline?",
    options: [
  ...
  },
  {
    id: 376,
    question:
      "Which combination makes offline-first behavior effective in React Query?",
    options: [
  ...
  },
  {
    id: 377,
    question:
      "Why is React Query important for managing server data in React apps?",
    options: [
  ...
  },
  {
    id: 378,
    question:
      "Which of the following problems does React Query help solve in React applications?",
    options: [
  ...
  },
  {
    id: 379,
    question:
      "Why might a complex React app be difficult to manage without React Query?",
    options: [
  ...
  },
  {
    id: 380,
    question:
      "What is the main difference between useQuery and useMutation in React Query?",
    options: [
  ...
  },
  {
    id: 381,
    question:
      "Which hook in React Query is primarily used for fetching and caching server data?",
    options: ["useMutation", "useReducer", "useQuery", "useEffect"],
    correctOption: 2,
    points: 10,
  },
  {
    id: 382,
    question:
      "In React Query, what happens if you provide the same queryKey to multiple useQuery hooks?",
    options: [
  ...
  },
  {
    id: 383,
    question:
      "Which of the following is a recommended pattern when using useQuery to prevent unnecessary network requests?",
    options: [
  ...
  },
  {
    id: 385,
    question:
      "Which hook is used in React Query to handle creating, updating, or deleting data on the server?",
    options: ["useQuery", "useMutation", "useReducer", "useState"],
    correctOption: 1,
    points: 10,
  },
  {
    id: 386,
    question:
      "After a successful mutation, what is the recommended way to update cached queries in React Query?",
    options: [
  ...
  },
  {
    id: 387,
    question:
      "Which of the following is TRUE about useMutation compared to useQuery?",
    options: [
  ...
  },
  {
    id: 389,
    question:
      "In React Query, what is the difference between staleTime and cacheTime?",
    options: [
  ...
  },
  {
    id: 390,
    question:
      "How can you prevent a useQuery from automatically running when the component mounts?",
    options: [
  ...
  },
  {
    id: 391,
    question:
      "Which callback in useMutation is best suited for updating the cache after a successful mutation?",
  ...
  },
  {
    id: 393,
    question:
      "Which React Query function is commonly used inside a mutation's onSuccess callback to refresh relevant queries?",
    options: [
      "resetQueries",
      "refetchQueries",
      "cancelQueries",
  ...
  },
  {
    id: 394,
    question:
      "What happens when multiple queries are dependent in React Query?",
    options: [
  ...
  },
  {
    id: 395,
    question:
      "Which tool helps visualize query and mutation states during development in React Query?",
    options: [
      "Redux DevTools",
  ...
  },
  {
    id: 396,
    question:
      "Which option in useQuery allows background data synchronization at regular intervals?",
  ...
  },
  {
    id: 399,
    question:
      "Which option in useQuery is helpful when implementing pagination to avoid showing a blank state while fetching new data?",
  ...
  },
  {
    id: 400,
    question:
      "How does React Query ensure consistency between server and client after a mutation?",
    options: [
  ...
  },
  {
    ...
    options: ["useState", "useForm", "useController", "useReducer"],
    correctOption: 1,
    points: 10,
  },
  {
  ...
  },
  {
    id: 406,
    question:
      "Which function in React Hook Form is responsible for handling form submission?",
    options: ["useSubmit", "submitForm", "handleSubmit", "onSubmitHandler"],
    correctOption: 2,
    points: 10,
  },
  {
    id: 407,
    question:
      "How can you apply validation rules such as 'required' or 'minLength' in React Hook Form?",
    options: [
  ...
  },
  {
    id: 409,
    question:
      "Why is React Hook Form considered performant compared to other form libraries?",
    options: [
  ...
  },
  {
    id: 410,
    question:
      "Which hook should you use to control custom components (like a date picker) in React Hook Form?",
    options: [
      "useController",
      "useFormContext",
      "useCustomInput",
  ...
  },
  {
    ...
    options: ["updateField", "setValue", "patch", "replaceValue"],
    correctOption: 1,
    points: 20,
  },
  {
  ...
  },
  {
    id: 414,
    question:
      "Which option best describes the role of resolvers in React Hook Form?",
    options: [
  ...
  },
  {
    id: 415,
    question:
      "Which hook would you use to read the current value of a field without subscribing to its updates?",
    options: ["getValues", "watch", "setValue", "trigger"],
    correctOption: 0,
    points: 25,
  },
  {
    id: 416,
    question:
      "How can you implement async validation, such as checking if a username already exists?",
    options: [
  ...
  },
  {
    id: 417,
    question:
      "What is one key performance advantage of React Hook Form compared to Formik?",
    options: [
  ...
  },
  {
    id: 418,
    question:
      "What is the primary purpose of the useForm hook in React Hook Form?",
    options: [
  ...
  },
  {
    id: 419,
    question:
      "Which prop must be applied to an input field for React Hook Form to track its value?",
    options: ["onChange", "value", "register", "ref"],
    correctOption: 2,
    points: 10,
  },
  {
  ...
  },
  {
    id: 422,
    question:
      "Which hook allows you to subscribe to changes in specific form fields?",
    options: ["useEffect", "watch", "useFormContext", "trigger"],
    correctOption: 1,
    points: 10,
  },
  {
  ...
  },
  {
    id: 424,
    question:
      "Which method is used to manually trigger validation for one or more fields?",
    options: ["reset", "validate", "trigger", "checkValidity"],
    correctOption: 2,
    points: 20,
  },
  {
    ...
    options: ["resetForm()", "reset()", "clear()", "resetFields()"],
    correctOption: 1,
    points: 20,
  },
  {
    id: 426,
    question:
      "In TanStack Query, which option should you set to 'false' to prevent a query from automatically running when the component mounts?",
    options: [
      "`enabled`",
      "`refetchOnMount`",
  ...
  },
  {
    id: 427,
    question:
      "Which TanStack Query option controls whether a query should refetch when the browser window regains focus?",
    options: [
      "`enabled`",
  ...
  },
  {
    id: 428,
    question:
      "You want your query to poll data every 10 seconds, even when the browser tab is in the background. Which combination of options should you use?",
    options: [
  ...
  },
  {
    id: 429,
    question:
      "In TanStack Query, what does the `refetchIntervalOnMount` option control?",
    options: [
  ...
  },
  {
    id: 430,
    question:
      "In TanStack Query, when cached data becomes stale, what happens?",
    options: [
  ...
  },
  {
    id: 432,
    question:
      "Which combination of options allows polling of server data at a fixed interval even when the tab is in the background?",
    options: [
  ...
  },
  {
    id: 434,
    question:
      "Which of the following represents the 'Read' operation in a CRUD system?",
    options: [
  ...
  },
  {
    id: 435,
    question:
      "In the context of React and Supabase, which hook is most commonly used for performing the 'Update' operation in CRUD?",
    options: ["useEffect", "useQuery", "useMutation", "useContext"],
    correctOption: 2,
    points: 30,
  },
  {
    id: 436,
    question:
      "Which CRUD operation is performed when a new record is inserted into a database?",
  ...
  },
  {
    id: 437,
    question:
      "Which CRUD operation is being executed when data is retrieved from an API endpoint?",
    options: ["Create", "Read", "Update", "Delete"],
    correctOption: 1,
    points: 10,
  },
  {
    id: 438,
    question:
      "When modifying an existing user's email address, which CRUD operation is applied?",
    options: ["Create", "Read", "Update", "Delete"],
    correctOption: 2,
    points: 10,
  },
  {
    id: 439,
    question:
      "Which CRUD action is executed when a record is permanently removed from a database?",
    options: ["Create", "Read", "Update", "Delete"],
    correctOption: 3,
    points: 10,
  },
  {
    id: 440,
    question:
      "In React applications, which hook is most suitable for executing Create, Update, or Delete operations?",
  ...
  },
  {
    id: 441,
    question:
      "Which CRUD operation usually requires invalidating or refetching cached queries in client-side state management libraries?",
  ...
  },
  {
    id: 442,
    question:
      "Why is the Update operation often considered more complex than Create in CRUD systems?",
    options: [
  ...
  },
  {
    id: 447,
    question:
      "How does TypeScript handle null and undefined in a variable of type string?",
    options: [
  ...
  },
  {
    id: 448,
    question:
      "Why is TypeScript considered helpful in large-scale React projects?",
    options: [
  ...
  },
  {
    id: 449,
    question:
      "Which TypeScript feature helps prevent passing an incorrect object shape to a function?",
    options: [
  ...
  },
  {
    id: 450,
    question:
      "What kind of errors does TypeScript detect before the program runs?",
    options: [
  ...
  },
  {
    id: 451,
    question:
      "Which of the following will TypeScript catch during development, before execution?",
    options: [
      "Accessing a property that does not exist on an object",
  ...
  },
  {
    id: 452,
    question:
      "Why is detecting errors at compile-time useful in large React projects?",
    options: [
  ...
  },
  {
    id: 453,
    question:
      "Which scenario is a compile-time error that TypeScript can detect?",
    options: [
  ...
  },
  {
    id: 454,
    question:
      "Which TypeScript feature ensures errors are detected before runtime?",
    options: [
      "Static type checking",
      "React hooks",
      "CSS modules",
  ...
  },
  {
    id: 457,
    question:
      "Why does React Hook Form (RHF) typically trigger fewer re-renders compared to other form libraries?",
    options: [
  ...
  },
  {
    id: 459,
    question:
      "In React Hook Form, what is the best practice for showing validation errors using field touch state?",
    options: [
  ...
  },
  {
    id: 460,
    question:
      "Which is the best practice for showing error messages in React Hook Form?",
    options: [
  ...
  },
  {
    id: 461,
    question:
      "Why does using `onTouched` improve user experience in forms built with React Hook Form?",
    options: [
  ...
  },
  {
    id: 462,
    question:
      "Why do we use the spread operator (`...register`) when integrating inputs with React Hook Form?",
    options: [
  ...
  },
  {
    id: 463,
    question:
      "What would happen if you use `register('email')` without the spread operator inside an input?",
    options: [
  ...
  },
  {
    id: 464,
    question:
      "Which of the following best describes what `...register('name', { required: 'This field is required' })` does?",
    options: [
  ...
  },
  {
    id: 466,
    question:
      "Which of the following best demonstrates the Render Props pattern?",
    options: [
  ...
  },
  {
    id: 467,
    question:
      "Why has the usage of Render Props pattern decreased in modern React applications?",
    options: [
  ...
  },
  {
    id: 468,
    question:
      "What is the main purpose of the Compound Component Pattern in React?",
    options: [
  ...
  },
  {
    id: 469,
    question:
      "Which technique is most commonly used to share state between parent and child components in the Compound Component Pattern?",
    options: [
      "Prop drilling",
      "React Context",
      "Redux store",
  ...
  },
  {
    id: 470,
    question:
      "Why is using a compound component like Tabs with Tabs.List and Tabs.Panel preferred over a single Tabs component with many props?",
    options: [
  ...
  },
  {
    id: 471,
    question:
      "What problem does the Compound Component Pattern solve compared to a single monolithic component?",
    options: [
  ...
  },
  {
    id: 472,
    question:
      "When implementing a Compound Component Pattern, how do children usually access the parent’s state and logic?",
    options: [
  ...
  },
  {
    id: 475,
    question:
      "What is the main purpose of using React Portal when rendering a modal?",
    options: [
  ...
  },
  {
    id: 477,
    question:
      "Why is using React Portal beneficial for modals in terms of CSS and layout?",
    options: [
  ...
  },
  {
    id: 479,
    question:
      "In terms of accessibility (a11y), what is an important step when building a Portal Modal?",
    options: [
